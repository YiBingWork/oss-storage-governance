...
-- 审计日志
INSERT INTO audit_logs (bucket_name, request_time, access_key_id, source_ip, event_name, object_key, response_code, latency_ms, raw_log_json) VALUES
('data-warehouse-prod', '2025-03-24 10:15:30', 'AKIAIOSFODNN7EXAMPLE', '192.168.1.10', 'PutObject', 'dw/ods/user_action/dt=2025-03-24/data.csv', 200, 120, '{"eventVersion":"1.0","eventSource":"oss","eventName":"PutObject","requestParameters":{"bucketName":"data-warehouse-prod","key":"dw/ods/user_action/dt=2025-03-24/data.csv"}}'),
('data-warehouse-prod', '2025-03-24 10:16:05', 'AKIAIOSFODNN7EXAMPLE', '192.168.1.10', 'GetObject', 'dw/ods/user_action/dt=2025-03-24/data.csv', 200, 45, '{"eventVersion":"1.0","eventSource":"oss","eventName":"GetObject","requestParameters":{"bucketName":"data-warehouse-prod","key":"dw/ods/user_action/dt=2025-03-24/data.csv"}}'),
('user-logs-prod', '2025-03-24 10:20:12', 'AKIAIOSFODNN8EXAMPLE', '10.0.0.55', 'GetBucketPolicy', '', 403, 15, '{"eventVersion":"1.0","eventSource":"oss","eventName":"GetBucketPolicy","requestParameters":{"bucketName":"user-logs-prod"},"errorCode":"AccessDenied","errorMessage":"Access Denied"}'),
('data-warehouse-staging', '2025-03-24 10:25:00', 'AKIAIOSFODNN9EXAMPLE', '172.16.0.100', 'DeleteBucket', '', 403, 20, '{"eventVersion":"1.0","eventSource":"oss","eventName":"DeleteBucket","requestParameters":{"bucketName":"data-warehouse-staging"},"errorCode":"AccessDenied","errorMessage":"Access Denied"}'),
('ml-training-data', '2025-03-24 10:30:45', 'AKIAIOSFODNN7EXAMPLE', '192.168.1.15', 'DeleteObjects', 'training/image_set_v3/batch1/', 200, 450, '{"eventVersion":"1.0","eventSource":"oss","eventName":"DeleteObjects","requestParameters":{"bucketName":"ml-training-data","key":"training/image_set_v3/batch1/"}}'),
('backup-archive', '2025-03-24 10:35:10', 'AKIAIOSFODNN8EXAMPLE', '10.0.0.55', 'ListObjects', 'backups/2024/', 200, 85, '{"eventVersion":"1.0","eventSource":"oss","eventName":"ListObjects","requestParameters":{"bucketName":"backup-archive","prefix":"backups/2024/"}}'),
('data-warehouse-prod', '2025-03-24 10:40:22', 'AKIAIOSFODNN7EXAMPLE', '192.168.1.10', 'PutObject', 'dw/dwd/order_detail/dt=2025-03-24/part-00000.parquet', 200, 210, '{"eventVersion":"1.0","eventSource":"oss","eventName":"PutObject","requestParameters":{"bucketName":"data-warehouse-prod","key":"dw/dwd/order_detail/dt=2025-03-24/part-00000.parquet"}}'),
('user-logs-prod', '2025-03-24 10:45:00', 'UNKNOWN', '203.0.113.42', 'GetObject', 'logs/app/2025/config.json', 404, 10, '{"eventVersion":"1.0","eventSource":"oss","eventName":"GetObject","requestParameters":{"bucketName":"user-logs-prod","key":"logs/app/2025/config.json"},"errorCode":"NoSuchKey","errorMessage":"The specified key does not exist."}'),
('data-warehouse-staging', '2025-03-24 10:50:33', 'AKIAIOSFODNN9EXAMPLE', '172.16.0.100', 'PutObjectACL', 'staging/temp_etl/test.txt', 200, 30, '{"eventVersion":"1.0","eventSource":"oss","eventName":"PutObjectACL","requestParameters":{"bucketName":"data-warehouse-staging","key":"staging/temp_etl/test.txt"}}'),
('data-warehouse-prod', '2025-03-24 11:00:00', 'AKIAIOSFODNN7EXAMPLE', '192.168.1.10', 'DeleteObject', 'dw/tmp/debug_output.csv', 204, 60, '{"eventVersion":"1.0","eventSource":"oss","eventName":"DeleteObject","requestParameters":{"bucketName":"data-warehouse-prod","key":"dw/tmp/debug_output.csv"}}');
